...
Public Class EMPLEADOS
    ...
    Private Sub btnModificarEmpleado_Click(sender As Object, e As EventArgs) Handles btnModificarEmpleado.Click
        Dim Comm As New SqlCommand()
        Comm.Connection = connsql
        Comm.CommandText = "UpDate EMPLEADOS set Id_Usuario=@Id_Usuario, Nombre=@Nombre, A_Paterno=@A_Paterno,A_Materno=A_Materno,Direccion=@Direccion,Tel=@Tel,Email=@Email,F_Nac=@F_Nac,RFC=@RFC,F_Ingreso=@F_Ingreso,Id_Categoria=@Id_Categoria,Foto=@Foto where Empleados.Id_Usuario = @Id_Usuario" '& "values(@Id_Usuario,@Nombre,@A_Paterno,@A_Materno,@Direccion,@Tel,@Email,@F_Nac,@Rfc,@F_Ingreso,@Id_Categoria,@Foto where Empleados.Id_Usuario = @Id_Usuario)"
        Comm.CommandType = CommandType.Text
        Comm.Parameters.Add("@Id_Usuario", SqlDbType.NChar, 10).Value = txtId.Text.ToString()
        Comm.Parameters.Add("@Nombre", SqlDbType.NChar, 20).Value = txtNom.Text.ToString()
        ...
        Comm.Parameters.Add("@F_Ingreso", SqlDbType.Date).Value = txtIngreso.Text.ToString()
        Comm.Parameters.Add("@Id_Categoria", SqlDbType.NChar, 8).Value = txtIdCat.Text.ToString()
